## API Report File for "@azure-iot/azure-service-bus"
...
export class QueueClient implements Client {
    ...
    peekBySequenceNumber(fromSequenceNumber: Long_2, maxMessageCount?: number): Promise<ReceivedMessageInfo[]>;
}
...
export class Receiver {
    ...
    receiveDeferredMessage(sequenceNumber: Long_2): Promise<ServiceBusMessage | undefined>;
    receiveDeferredMessages(sequenceNumbers: Long_2[]): Promise<ServiceBusMessage[]>;
...
export class Sender {
    ...
    get isClosed(): boolean;
    open(): Promise<void>;
    scheduleMessage(scheduledEnqueueTimeUtc: Date, message: SendableMessageInfo): Promise<Long_2>;
    scheduleMessages(scheduledEnqueueTimeUtc: Date, messages: SendableMessageInfo[]): Promise<Long_2[]>;
